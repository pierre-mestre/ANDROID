...
FOR %%x IN ("D:\Pierre MESTRE\Desktop\ANDROID\PROJET\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\Pierre MESTRE\Desktop\ANDROID\PROJET\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\Pierre MESTRE\Desktop\ANDROID\PROJET\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\Pierre MESTRE\Desktop\ANDROID\PROJET\php\php.exe"
GOTO :INSTALLED
